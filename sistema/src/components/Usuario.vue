                ...
                <template slot="items" slot-scope="props">
                    <td class="justify-center layout px-0">
                        ...
                        <template v-if="props.item.condicion">
                         ...
                         <template v-else="props.item.condicion">
                            <v-icon
                            small
                    ...
                    <td>
                        <div v-if="props.item.condicion">
                         ...
                         <div v-else="props.item.condicion">
        ...
        methods:{
            ...
            validar(){
                ...
                if(this.nombre.length<3 || this.nombre.length>100){
                    this.validaMensaje.push("El nombre debe de tener mas de 3 caracteres y menos de 100 caracteres")
                }
                if(!this.idrol){
            ...
            activarDesactivarMostrar(accion,item){
                ...
                if(accion==1){
                    ...
                    this.adAccion=1;
                    //alert("Activar " + item.nombre)
                }else if(accion==2){
                    this.adAccion=2;
                    //alert("Desactivar " +item.nombre);
